  ...
  return (
    <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 4xl:grid-cols-4 gap-x-5 gap-y-5">
      <KpiBlock
        ...
        title={t("kpi.kpiBlocks.0")}
        value={texter}
      />
      <KpiBlock
        icon={faMoneyBillWave}
        title={t("kpi.kpiBlocks.1")}
        value={lector}
      />
      <KpiBlock
        icon={faMoneyBillWave}
        title={t("kpi.kpiBlocks.2")}
        value={seo}
      />
      <KpiBlock
        icon={faMoneyBillWave}
        title={t("kpi.kpiBlocks.3")}
        value={meta}
      />
      <KpiBlock icon={faRocket} title={t("kpi.kpiBlocks.4")} value={revenue} />
      <KpiBlock icon={faEuroSign} title={t("kpi.kpiBlocks.5")} value={totalCost} />
