...
export const GroupDateField: React.FC<GroupDateFieldProps> = ({
  ...
  return (
    <div className="w-full flex flex-col gap-1 py-2.5">
      ...
      <DatePicker
        className="w-full bg-slate-100 placeholder:text-black/60 dark:placeholder:text-white/50 rounded border border-transparent bg-gray-100 py-2 px-4 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary"
