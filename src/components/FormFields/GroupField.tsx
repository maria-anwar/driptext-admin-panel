  ...
  return (
    <>
      <div className="w-full flex flex-col gap-1 py-2.5">
        ...
        <input
          className={`${disabled ? ' text-black bg-slate-200':''} placeholder:text-black/60 dark:placeholder:text-white/50 bg-slate-200 w-full text-black dark:text-white text-xs xs:text-sm px-2 xs:px-3.5 font-normal py-3 focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 focus:border-1 dark:focus:border-primary rounded`}
          type={type}
